...
--
  ...
  --
INSERT INTO
  `admin` (`username`, `password`, `nama`, `email`, `telp`)
VALUES
  (
    'admin',
...
VALUES
  (
    ...
    2017,
    2020,
    'cindy.bismhaniac@gmail.com',
    '082217504443',
    'Rt. 02 Karya baru . lambur'
  ),
  (
    '17103321',
    'Saiful Rizal',
    ...
    2017,
    2020,
    'Saiful.rizal.96387@gmail.com',
    '085378051554',
    'Rt. 11 Dusun mandiri , kota harapan'
  ),
  (
    '17102258',
    'Mery',
    ...
    'mery,037@gmail.com',
    '082141012018',
    'Rt. 05 Dusun polewali, Lambur luar'
  ),
  (
    '17107534',
    'Lita Sandra Dewi',
    ...
    2017,
    2020,
    'lita.alhdyt@gmail.com',
    '081377514246',
    'Rt. 01 Dusun Karya baru, Lambur luar'
  ),
  (
    '17108692',
    'Desmawati',
...
VALUES
  (
    3,
    'Banguan sekolah',
    './files/berita/berita_img1625240365.jpg',
    '<p>-</p>',
    '1614038400',
    'admin',
    13
...
--
  ...
  --
INSERT INTO
  `carousel` (`id`, `file`, `header`, `text`)
VALUES
  (
    7,
    './files/profil_sekolah/carousel_img1625238031.jpg',
    'KOTA HARAPAN',
    'lmiyah'
  ),
  (
    6,
    './files/profil_sekolah/carousel_img1625238021.jpg',
    'MTs DARUL DA\'WAH WAL IRSYAD',
    'Beramal'
  ),
  (
    5,
    './files/profil_sekolah/carousel_img1625237647.jpg',
    'DI',
    'Amaliyah'
  ),
  (
    4,
    './files/profil_sekolah/carousel_img1625237656.jpg',
    'Selamat Datang',
    'Berilmu'
  );
-- --------------------------------------------------------
...
--
  ...
  --
INSERT INTO
  `fasilitas` (`id`, `gambar`, `nama`, `jumlah`, `deskripsi`)
VALUES
...
--
  ...
  --
INSERT INTO
  `gallery` (`id`, `file`, `caption`)
VALUES
  (
    5,
    './files/gallery/gallery_img1614528104.jpg',
    'a sd2'
  );
-- --------------------------------------------------------
  --
...
VALUES
  (
    ...
    'Simbur Naik',
    '18-08-1995',
    'wahdah.thamrin@gmail.com',
    '081367450065',
    'Rt, 10  Dusun pada idi kota harapan',
    NULL,
    'Wahdah Thamrin',
    '',
    '081367450065'
  ...
  (
    ...
    'Lambur, Jambi',
    '10-03-1988',
    'Muammar.muhammad.3@gmail.com',
    '082289841412',
    'Rt. 01 Dusun Karya Baru, Jambi',
    NULL,
    'Moeammar Marly',
    '-',
    '-'
  ...
  (
    ...
    'Lambur Luar',
    '03-08-1981',
    'Suhartang.damar@gmail.com',
    '082286364737',
    'Rt. 10 Dususn padaidi , kota harapan',
    NULL,
    'Muhammad Suhartang Alfatih',
    '',
    '082286364737'
  ),
  (
    ...
    'Karya Baru',
    '03-12-1996',
    'lissdaaja0396@gmail.com',
    '082177551214',
    'Rt. 02 Dusun Karya Baru, Lambur Luar',
    NULL,
    'Lisda Yanti',
    '',
    '082177551214'
...
VALUES
  ...
  (
    4,
    'Senin',
    'Belajar aktif (lanjutan), kembali pulang ke rumah',
    '12:45',
    '13:30',
    NULL
  ),
  ...
  (
    12,
    'Kamis',
    'Pembelajaran Kosa Kata Dan Muhadaroh Tiga Bahasa, Ishoma',
    '8:00',
    '11:45',
    NULL
  ),
...
--
  ...
  --
INSERT INTO
  `pengunjung` (`id`, `ip`, `useragent`, `tanggal`, `bulan`)
VALUES
  (
    3,
    '127.0.0.1',
    'Windows 7, Chrome 88.0.4324.190',
    '1614433397',
    2
  ),
  (
  ...
  (
    9,
    '127.0.0.1',
    'Windows 7, Chrome 89.0.4389.114',
    '1617682925',
    4
  ),
  (
  ...
  (
    11,
    '::1',
    'Windows 10, Chrome 91.0.4472.101',
    '1623664071',
    6
  ),
  (
  ...
  (
    17,
    '::1',
    'Windows 10, Chrome 91.0.4472.106',
    '1624007677',
    6
  ),
  (
  ...
  (
    23,
    '::1',
    'Windows 10, Chrome 77.0.3865.90',
    '1625076356',
    6
  ),
  (
...
VALUES
  (
    ...
    'Prestasi 1..',
    'Nasional',
    './files/profil_sekolah/prestasi_img1614504938.jpg',
    '01-02-2021',
    '<p>das dasd as w wq</p>'
  );
-- --------------------------------------------------------
  --
...
--
  ...
  --
INSERT INTO
  `profil_sekolah` (`id`, `text`, `nilai`, `inputtype`)
VALUES
  (
    'alamat',
    'Alamat Sekolah',
    'Jln. Melati RT 007 Dusun Pada Idi Desa Kota Harapan Kecematan Muara Sabak Timur Kabupaten Tanjung Jabung Timur.',
    'textarea'
  ),
  (
    'phone',
  ...
  (
    'email',
    'Email Sekolah',
    'mtsddikotaharapan@gmail.com',
    'text'
  ),
  (
    'nama_sekolah',
    'Nama Sekolah',
    'Darud Da’wah Wal Irsyad Kota Harapan',
    'text'
  ),
  (
    'nama_singkat_sekolah',
    'Singkatan Sekolah',
    'MTs DDI Kota Harapan',
    'text'
  ),
  ...
  (
    'no_sk_kanwil',
    'Nomor SK Kanwil Kemenag Jambi',
    'Kw 05.4/4/PP.03.3/417/2006',
    'text'
  ),
  ...
  (
    'visi',
    'Visi',
    '<p>Berilmu Amaliyah Beramal lmiyah.</p>\r\n',
    'textarea'
  ),
  (
    'luas_tanah',
  ...
  (
    'luas_sisa',
    'Luas lahan yang belum digunakan',
    '1000',
    'int'
  ),
  (
    'sejarah',
    'Sejarah Sekolah',
    '<p>Pada tahun 1980 Pengurus Yayasan Darud Da’wah Wal Irsyad bersama pemerintah setempat dan warga Desa Kota Harapan bersepakat dalam sebuah musyawarah pendirian Madrasah Tsanawiyah Darud Da’wah Wal Irsyad sebagai bentuk pendidikan formal dengan identitas Madrasah Darud Da’wah Wal Irsyad.</p>\r\n\r\n<p>Didirikan Pada 28 Februari 2006, yang direskimkan oleh Kanwil Kemenag Prov Jambi dengan nomor SK Kanwol Kemenag Jambi No:Kw 05.4/4/PP.03.3/417/2006.</p>\r\n',
    'textarea'
  ),
  (
    'struktur',
    'Gambar Struktur Organisasi',
    './files/profil_sekolah/struktur_img1614438129.JPG',
    'text'
  ),
  (
    'keterangan_struktur',
  ...
  (
    'email_petugas_psb',
    'Email Petugas Penerimaan Siswa Baru',
    'sulaimanmei@gmail.com',
    'text'
  ),
  (
    'password_email',
    'Password Email Sekolah',
    'kotaharapan123',
    'textarea'
  );
-- --------------------------------------------------------
...
VALUES
  (
    ...
    '02-04-2007',
    2020,
    'aksas.ardiansyah@gmail.com',
    '082281303396',
    'Rt. 09 dusun pada idi kota harapan'
  ),
  (
    '20504210',
    'Ayustia Miranda',
    ...
    '13-08-2007',
    2020,
    'ayustia.miranda.1@gmail.com',
    '085244177664',
    'Rt. 02 Setia palapa. lambur luar'
  ),
  (
    '20504255',
    'M. Fadlan',
    ...
    '23-04-2008',
    2020,
    'm.fadlan.3572@gmail,com',
    '082353479069',
    'Rt. 11 Dusun pada idi kota harapan'
  ),
  (
    '20504212',
    'Kasih Febriyana Haida',
    'Wanita',
    'Lambur Luar',
    '02-02-2008',
    2020,
    'kasih.haida@gmail.com',
    '082283776636',
    'Rt. 02 Dusun setia palapa, Lambur luar'
  ),
  (
    '20504207',
    'Nurhayati',
