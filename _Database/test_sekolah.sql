...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 09, 2021 at 03:53 AM
...
CREATE TABLE IF NOT EXISTS `alumni` (
  ...
  `tahun_masuk` int NOT NULL DEFAULT '2021',
  `tahun_lulus` int NOT NULL DEFAULT '2020',
  `email` varchar(50) DEFAULT NULL,
...
('3', 'Wahda, S.P.d', 'Bendahar Madrasah', 'Wanita', 'Simbur Naik', '18-08-1995', 'wahdah.thamrin@gmail.com', '081367450065', 'Rt, 10  Dusun pada idi kota harapan', NULL, 'Wahdah Thamrin', '', '081367450065'),
('1', 'Desi Ismayanti, S.Pd', 'Kepala Madrasah', 'Wanita', 'Kota Harapan, Jambi', '17-04-1995', 'desiisma08@gmail.com', '082371323239', 'Rt. 11 Dusun Mandiri. Kota Harapan', NULL, '-', '-', '082371323239'),
('2', 'Muamar, S.Pd', 'Wakil Kepala Madrasah', 'Pria', 'Lambur, Jambi', '10-03-1988', 'Muammar.muhammad.3@gmail.com', '082289841412', 'Rt. 01 Dusun Karya Baru, Jambi', NULL, 'Moeammar Marly', '-', '-'),
...
(' ', 'Lisda Yanti, S.Pd', 'Kepala Perpustakaan', 'Wanita', 'Karya Baru', '03-12-1996', 'lissdaaja0396@gmail.com', '082177551214', 'Rt. 02 Dusun Karya Baru, Lambur Luar', NULL, 'Lisda Yanti', '', '082177551214');
...
--
-- Dumping data for table `kegiatan_siswa`
--
